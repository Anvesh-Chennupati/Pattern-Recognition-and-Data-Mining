  ...
  public:
    ...
    class Node
    {
      ...
      public:
        ...
        // 	os.write(reinterpret_cast<const char*>(&m_dimSplitValue), sizeof(vector<double>));
        ...
        // 	is.read(reinterpret_cast<char*>(&m_dimSplitValue), sizeof(vector<double>));
